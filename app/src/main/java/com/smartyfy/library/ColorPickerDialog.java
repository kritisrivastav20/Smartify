...
public class ColorPickerDialog {
     ...
     */
    public ColorPickerDialog(final Context context, int color, OnAmbilWarnaListener listener, int style) {
        this(context, color, false, listener, style);
    }
     ...
     * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
     */
    public ColorPickerDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener, int style) {
